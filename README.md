...
<p align="center">
  <a href="https://samuelmataraso.com">
    <img src="https://i.imgur.com/EDW1zPx.jpg" alt="Logo">
  </a>

  <h3 align="center">Template Freya Basic</h3>
</p>
...
Este projeto visa a criação de um template usando o padrão de Arquitetura Module/Feature que possa ser utilizado no momento de criação de projetos utilizando React Native, visto que o processo de instalação e configuração das libs no início de um projeto podem gerar certa complexidade e muitas vezes até erros que atrasam o processo, atrapalhando assim o fluxo de desenvolvimento.
...
```sh
react-native init AwesomeExample --template freya-basic
```
...
- **src** - Diretório contendo todos os arquivos da aplicação, é criado um diretório `src` para que o código da aplicação possa ser isolado em um diretório e facilmente portado para outros projetos, se necessário;
  ...
  - **components** - Diretório para guardar todo tipo de component criado na sua aplicação.
    ...
    - **common** - Diretório para guardar components comuns na aplicação, no caso components que são usados em mais de uma feature.
  ...
  - **modules** - Diretório onde ficam as páginas (telas) da aplicação, como forma de padronização e boas práticas toda página fica dentro de um diretório com seu nome;
    ...
    - **Main** - Diretório exemplo de uma página cujo nome é **Main**, por padrão foi adotado usar sempre como nome do diretório o nome da página em camelCase, dentro desse diretório é necessária a criação ao menos do arquivo `index.js`;
      ...
      - **components** - Diretório para guardar apenas components relacionados a essa feature.
